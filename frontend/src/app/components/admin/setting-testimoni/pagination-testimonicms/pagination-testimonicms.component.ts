...
@Component({
  selector: 'app-pagination-testimonicms',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule
  ],
  templateUrl: './pagination-testimonicms.component.html',
  styleUrl: './pagination-testimonicms.component.scss'
})
export class PaginationTestimonicmsComponent {
